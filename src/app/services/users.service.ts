...
export class UsersService {
  ...
  postData(userData: any, fun: any) {
    this.httpService
      .post(environment.serverUrl + environment.users.postCreate, userData)
  ...
  updateData(user_id: string, userData: any, fun: any) {
    this.httpService
      .put(
        environment.serverUrl + environment.users.putById + user_id,
        userData
      )
      .subscribe((response: any) => {
        if (response.status == 200) {
